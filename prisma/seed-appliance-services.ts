...
const SERVICES: ServiceSeed[] = [
  {
    ...
    packages: [
      { name: "Top & Front Load Diagnosis", price: 299, originalPrice: 499, time: "30 mins", category: "Bestsellers", tag: "Bestseller", rating: "4.8 (2,140)", image: WASHING_MACHINE_IMG, features: ["Complete fault diagnosis", "No-obligation quote", "All brands covered", "Labour included"], details: ["Multi-point electrical and mechanical inspection of the wash and spin cycle", "Clear, itemised quote before any repair work begins", "Covers front-load, top-load and semi-automatic machines"] },
      { name: "Spin/Drain Motor Repair", price: 899, originalPrice: 1299, time: "60 mins", category: "Repairs", tag: "Genuine Parts", rating: "4.7 (1,380)", image: WASHING_MACHINE_IMG, features: ["Genuine motor/pump parts", "Drain line unclogging", "Belt & coupler check", "60-day part warranty"], details: ["Removal and replacement of the faulty spin or drain motor with genuine parts", "Drain hose and pump filter unclogging to restore full discharge", "Full-load test cycle confirming spin balance and drainage"] },
      { name: "Drum & Gasket Deep Service", price: 649, originalPrice: 999, time: "50 mins", category: "Servicing", tag: "Popular", rating: "4.6 (980)", image: WASHING_MACHINE_IMG, features: ["Drum descaling & sanitisation", "Gasket mould removal", "Odour treatment", "Full cycle test run"], details: ["Chemical descaling of the wash drum removing detergent residue and hard-water scale", "Rubber gasket cleaning and anti-fungal treatment to stop persistent odour", "Complete test wash cycle verifying spin, drainage and heating"] },
    ],
  },
  {
    ...
    packages: [
      { name: "Standard Diagnosis Visit", price: 199, originalPrice: 349, time: "20 mins", category: "Bestsellers", tag: "Bestseller", rating: "4.8 (1,760)", image: MICROWAVE_IMG, features: ["Full diagnostic check", "Radiation safety test", "No-obligation quote", "All brands covered"], details: ["Complete electrical and mechanical inspection to find the exact fault", "Radiation leakage test performed before and after any repair", "Clear quote provided before any work begins"] },
      { name: "Magnetron / Heating Fix", price: 799, originalPrice: 1199, time: "45 mins", category: "Repairs", tag: "Genuine Parts", rating: "4.6 (640)", image: MICROWAVE_IMG, features: ["Genuine magnetron/capacitor", "High-voltage safety check", "Even-heating test", "60-day part warranty"], details: ["Replacement of the faulty magnetron or high-voltage capacitor with genuine parts", "Full high-voltage circuit safety inspection", "Even food-heating test across the full cavity"] },
      { name: "Touch Panel / Display Repair", price: 549, originalPrice: 899, time: "40 mins", category: "Repairs", tag: "Quick Fix", rating: "4.5 (410)", image: MICROWAVE_IMG, features: ["Panel/keypad replacement", "Display calibration", "Function test", "30-day warranty"], details: ["Diagnosis and replacement of unresponsive touch panel or button assembly", "Display and timer calibration after part replacement", "Full function test across all cooking modes"] },
    ],
  },
  {
    slug: "geyser-repair",
    ...
    packages: [
      { name: "Geyser Inspection & Safety Check", price: 249, originalPrice: 399, time: "30 mins", category: "Bestsellers", tag: "Bestseller", rating: "4.8 (2,010)", image: GEYSER_IMG, features: ["Electrical safety check", "Thermostat inspection", "Leak check", "No-obligation quote"], details: ["Full inspection of wiring, thermostat and pressure valve for shock/leak risk", "Clear, itemised quote before any repair work begins"] },
      { name: "Heating Element Replacement", price: 899, originalPrice: 1349, time: "60 mins", category: "Repairs", tag: "Genuine Parts", rating: "4.7 (890)", image: GEYSER_IMG, features: ["Genuine heating element", "Thermostat calibration", "Heating speed test", "60-day part warranty"], details: ["Replacement of the burnt or worn heating element with a genuine, brand-matched part", "Thermostat recalibration for accurate temperature control", "Heating-speed test to confirm peak performance"] },
      { name: "Tank Descaling & Deep Service", price: 599, originalPrice: 949, time: "50 mins", category: "Servicing", tag: "Popular", rating: "4.6 (720)", image: GEYSER_IMG, features: ["Full tank descaling", "Anode rod check", "Pressure valve test", "Efficiency test"], details: ["Chemical descaling of the tank to remove hard-water scale buildup", "Anode rod and pressure relief valve inspection", "Final heating-efficiency test to confirm improvement"] },
    ],
  },
  {
    slug: "tv-repair",
    ...
    packages: [
      { name: "TV Diagnosis Visit", price: 249, originalPrice: 399, time: "30 mins", category: "Bestsellers", tag: "Bestseller", rating: "4.7 (1,320)", image: TV_IMG, features: ["Full hardware diagnosis", "No-obligation quote", "All brands covered", "Labour included"], details: ["Complete diagnostic check of panel, sound, power and motherboard", "Clear, itemised quote before any repair work begins"] },
      { name: "Panel / Backlight Repair", price: 1499, originalPrice: 2199, time: "90 mins", category: "Repairs", tag: "Genuine Parts", rating: "4.6 (540)", image: TV_IMG, features: ["Genuine backlight/panel parts", "Dead pixel fix", "Colour calibration", "60-day part warranty"], details: ["Replacement of faulty backlight strips or damaged display panel sections", "Colour and brightness calibration after part replacement", "Full-screen test across multiple sources"] },
      { name: "Motherboard / Power Repair", price: 999, originalPrice: 1499, time: "75 mins", category: "Repairs", tag: "Quick Fix", rating: "4.5 (410)", image: TV_IMG, features: ["Motherboard/power supply fix", "Capacitor replacement", "Full A/V test", "60-day part warranty"], details: ["Diagnosis and repair of motherboard or power supply faults, including capacitor replacement", "Full audio/video test across HDMI, USB and antenna inputs"] },
    ],
  },
  {
    slug: "chimney-repair",
  ...
  },
  {
    ...
    packages: [
      { name: "Gas Stove Safety Inspection", price: 199, originalPrice: 349, time: "25 mins", category: "Bestsellers", tag: "Bestseller", rating: "4.8 (2,890)", image: GAS_STOVE_IMG, features: ["Full leak test", "Valve & knob check", "No-obligation quote", "All brands covered"], details: ["Complete leak test across all valves, pipe fittings and connection joints", "Inspection of control knobs and burner caps for wear"] },
      { name: "Burner Cleaning & Repair", price: 349, originalPrice: 549, time: "35 mins", category: "Repairs", tag: "Quick Fix", rating: "4.7 (1,420)", image: GAS_STOVE_IMG, features: ["Deep burner cleaning", "Flame calibration", "Airflow check", "30-day warranty"], details: ["Deep cleaning of clogged burner heads and jets to restore a strong blue flame", "Airflow and flame-colour calibration across all burners"] },
      { name: "Auto-Ignition / Valve Repair", price: 549, originalPrice: 849, time: "45 mins", category: "Repairs", tag: "Genuine Parts", rating: "4.6 (760)", image: GAS_STOVE_IMG, features: ["Genuine igniter/valve parts", "Wiring check", "Full ignition test", "60-day part warranty"], details: ["Replacement of a faulty igniter, battery or safety valve with genuine parts", "Full wiring inspection and ignition test across every burner"] },
    ],
  },
  {
  ...
  },
  {
    ...
    packages: [
      { name: "Full System Diagnosis", price: 299, originalPrice: 499, time: "30 mins", category: "Bestsellers", tag: "Bestseller", rating: "4.8 (1,890)", image: LAPTOP_IMG, features: ["Full hardware & software scan", "No-obligation quote", "All brands covered", "Labour included"], details: ["Extensive hardware and software diagnostic scan to uncover the exact fault", "Clear, itemised quote before any repair or upgrade begins"] },
      { name: "RAM / SSD Upgrade", price: 999, originalPrice: 1499, time: "45 mins", category: "Repairs", tag: "Quick Fix", rating: "4.8 (1,120)", image: LAPTOP_IMG, features: ["RAM/SSD installation", "Data migration", "Speed benchmark", "30-day warranty"], details: ["Installation of additional RAM or a solid-state drive to boost performance", "Safe data migration from the old drive where applicable", "Before/after speed benchmark to confirm the improvement"] },
      { name: "Virus Removal & OS Reinstall", price: 649, originalPrice: 999, time: "60 mins", category: "Repairs", tag: "Genuine Parts", rating: "4.6 (740)", image: LAPTOP_IMG, features: ["Full malware removal", "OS reinstall (if needed)", "Driver updates", "Performance test"], details: ["Deep malware and virus scan with complete removal of malicious software", "Fresh operating system install and driver updates where required", "Final boot-time and responsiveness performance test"] },
    ],
  },
];
