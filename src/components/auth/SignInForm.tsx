  ...
  return (
    <div className="flex flex-col">
      <div className="mb-5 text-center">
        ...
        <p className="text-[13px] text-slate-500 dark:text-slate-400 font-medium">Continue to your HomeTriangle account</p>
      </div>
      ...
      <form className="flex flex-col gap-4">
        ...
        <button 
          type="submit" 
          className="mt-1 w-full bg-[#00B4FF] hover:bg-[#0096fa] text-white rounded-lg py-2 text-[12px] font-bold flex items-center justify-center gap-2 transition-colors"
        >
          Sign in
        </button>
      </form>
