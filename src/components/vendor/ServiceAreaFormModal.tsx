...
import { addServiceAreaAction } from "@/actions/vendorservicearea.actions";
...
const inputClass =
  "w-full px-3.5 py-3 rounded-xl border-2 border-slate-200/60 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 text-sm font-bold tracking-wider text-slate-900 dark:text-white focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 placeholder:font-medium placeholder:tracking-normal placeholder:text-slate-400 transition-all shadow-inner";
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5 w-full pb-2">
        ...
        {/* Helper Banner */}
        <div className="bg-blue-50/80 dark:bg-blue-900/20 p-3 rounded-xl border border-blue-100 dark:border-blue-800/50 flex items-start gap-3">
          <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-800/50 flex items-center justify-center shrink-0">
            <ClientIcon icon="ph:info-duotone" className="w-4 h-4 text-blue-600 dark:text-blue-400" />
          </div>
          <div className="pt-0.5">
            <h4 className="text-sm font-bold text-blue-900 dark:text-blue-200 mb-0.5">How service areas work</h4>
            <p className="text-xs text-blue-700 dark:text-blue-300/80 leading-snug">
              When a customer requests a service in this pincode, you will be notified if they are within your specified radius. You can add multiple areas.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2 p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden">
          ...
          <div className="flex justify-between items-center relative z-10">
            ...
            <div className="flex items-center gap-1 bg-blue-50 dark:bg-blue-500/10 px-2.5 py-1 rounded-md border border-blue-100 dark:border-blue-500/20">
              <span className="font-black text-base text-blue-600 dark:text-blue-400 leading-none">{radiusKm}</span>
              <span className="text-[11px] font-bold text-blue-600/70 dark:text-blue-400/70 leading-none">km</span>
            </div>
          </div>
          ...
          <div className="relative pt-2 pb-1 z-10">
            <input
              ...
              className="w-full h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full appearance-none cursor-pointer accent-blue-600 dark:accent-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all"
            />
            <div className="flex justify-between mt-2 text-[11px] font-bold text-slate-400">
              <span className={radiusKm === 1 ? 'text-blue-500' : ''}>1 km</span>
              <span className={radiusKm === 13 ? 'text-blue-500' : ''}>13 km</span>
              <span className={radiusKm === 25 ? 'text-blue-500' : ''}>25 km</span>
            </div>
          </div>
          {errors.radiusKm && (
