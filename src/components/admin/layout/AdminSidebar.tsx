...
const navItems = [
  ...
  { label: "Categories", href: "/admin/categories", icon: "ph:tag" },
  { label: "Packages", href: "/admin/packages", icon: "ph:package" },
  { label: "Coupons", href: "/admin/coupons", icon: "ph:ticket" },
  { label: "Vendors & Co", href: "/admin/vendors", icon: "ph:buildings" },
  { label: "Vendor Technicians", href: "/admin/vendor-technicians", icon: "ph:users-three" },
  { label: "Freelance Technicians", href: "/admin/freelance-technicians", icon: "ph:user-gear" },
...
export function AdminSidebar({ isCollapsed, setCollapsed, isMobileMenuOpen, setMobileMenuOpen }: AdminSidebarProps) {
