...
const JOURNEY_STEPS = [
  {
    year: "2019",
    title: "Inception & First Center",
    desc: "What began as a small team of passionate service experts. We launched our first center with a small dedicated team.",
    tags: ["Humble Beginnings", "First Hub", "Small Team"],
    icon: "ph:rocket-launch-fill"
  },
  {
    year: "2021",
    title: "Rapid Expansion",
    desc: "Recognizing a gap in reliable home services, we expanded across the city with 5 new service hubs and onboarded our first 100 pros.",
    tags: ["5 New Hubs", "100+ Pros", "City-wide Reach"],
    icon: "ph:buildings-fill"
  },
  {
    year: "2023",
    title: "10,000+ Happy Clients",
    desc: "We reached a major milestone of 10,000 satisfied homeowners, processing thousands of bookings with unparalleled convenience and safety.",
    tags: ["10k Milestone", "Verified Trust", "High Volume"],
    icon: "ph:users-fill"
  },
  {
    year: "2024",
    title: "Industry Leadership",
    desc: "Recognized as the industry leader in premium services. We now operate 11 service centers, setting the gold standard for home integrations.",
    tags: ["11 Centers", "Gold Standard", "Premium Services"],
    icon: "ph:trophy-fill"
  }
];
...
export function JourneySection() {
  return (
    <section className="w-full bg-slate-50/50 dark:bg-[#0A0F1C]/50 py-16 sm:py-24 px-4 sm:px-8 lg:px-16 overflow-hidden border-t border-slate-100 dark:border-slate-800/50">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <SectionHeader
          title={
            <>
              From Local Roots to <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00B4FF] to-[#0070FF]">Global Reach.</span>
            </>
          }
          description="We identified a core gap in the market: finding reliable, vetted, and high-quality home services was too difficult. Here is how we solved it."
          alignment="center"
        />
                  ...
                  <div className={`flex flex-col lg:flex-row w-full items-start lg:items-center justify-between ${isRightSide ? 'lg:flex-row-reverse' : ''}`}>
                    ...
                    <div className="w-full lg:w-[45%] pl-10 sm:pl-14 lg:pl-0 relative">
                      ...
                      <div className="lg:hidden absolute left-0 sm:left-1 top-1 sm:top-2 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white dark:bg-[#0f1629] border-2 border-slate-200 dark:border-slate-800 flex items-center justify-center z-10 transition-all duration-300 group-hover:border-[#00B4FF] group-hover:shadow-[0_0_15px_rgba(0,180,255,0.3)] shadow-sm">
                        ...
                        <div className="absolute -top-1 -right-2 sm:-top-1.5 sm:-right-2 bg-[#00B4FF] text-white text-[7px] sm:text-[8px] font-bold rounded-full px-1.5 h-4 flex items-center justify-center shadow-sm border border-white dark:border-[#0f1629]">
                          {step.year}
                        </div>
                      </div>
                    ...
                    <div className="hidden lg:flex w-[10%] justify-center relative items-center">
                      ...
                      <div className="relative w-12 h-12 rounded-full bg-white dark:bg-[#0f1629] border-2 border-slate-200 dark:border-slate-800 flex items-center justify-center z-10 transition-all duration-300 group-hover:border-[#00B4FF] group-hover:shadow-[0_0_20px_rgba(0,180,255,0.4)] shadow-sm group-hover:scale-110">
                        ...
                        <div className="absolute -top-2 -right-3 bg-[#00B4FF] text-white text-[9px] font-bold rounded-full px-2 h-5 flex items-center justify-center shadow-md border-2 border-white dark:border-[#0f1629]">
                          {step.year}
                        </div>
                      </div>
                    </div>
