...
export function FeaturedServices() {
  return (
    <section className="w-full bg-slate-50 dark:bg-[#020813] py-10 sm:py-16 px-4 sm:px-8 xl:px-0 transition-colors duration-300 border-t border-slate-200 dark:border-slate-800/50">
