    ...
    <div className="flex flex-col w-full h-full max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage your company information and contact details</p>
        </div>
        <button className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2 w-full sm:w-auto">
          ...
          <div className="bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm flex flex-col items-center text-center relative overflow-hidden">
            ...
            <div className="relative group mt-8 mb-4">
              <div className="w-28 h-28 rounded-full bg-white dark:bg-[#0B1120] p-1.5 shadow-md border border-slate-100 dark:border-slate-800 relative z-10">
                <div className="w-full h-full rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center text-white font-bold text-3xl">
                  VN
                </div>
              </div>
            ...
            <h2 className="text-xl font-bold text-slate-900 dark:text-white relative z-10">Vendor Company</h2>
            <div className="flex items-center justify-center gap-1.5 mt-2 text-slate-500 dark:text-slate-400 text-sm font-medium relative z-10">
              <ClientIcon icon="ph:map-pin-fill" className="w-4 h-4 text-blue-500" />
              San Francisco, CA
            </div>
            ...
            <div className="w-full space-y-4 relative z-10">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="flex items-center gap-1.5 text-amber-500 font-bold">
                  <ClientIcon icon="ph:star-fill" className="w-4 h-4" /> 4.9
                </span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-500 dark:text-slate-400">Jobs Completed</span>
                <span className="text-slate-900 dark:text-slate-200 font-bold">142</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <ClientIcon icon="ph:buildings" className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 w-4.5 h-4.5" />
                  <input 
                    type="text" 
                    defaultValue="Vendor Company"
                    className="w-full bg-slate-50 dark:bg-[#1E293B]/50 border border-slate-200 dark:border-slate-700/50 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5 sm:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    type="email" 
                    defaultValue="contact@vendor.com"
                    className="w-full bg-slate-50 dark:bg-[#1E293B]/50 border border-slate-200 dark:border-slate-700/50 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5 sm:col-span-2">
                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Company Bio</label>
                <div className="relative">
                  <textarea 
                    rows={3}
                    defaultValue="We provide top-notch handy services across the Bay Area. Specializing in plumbing and electrical work."
                    className="w-full bg-slate-50 dark:bg-[#1E293B]/50 border border-slate-200 dark:border-slate-700/50 rounded-xl p-4 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all resize-none"
                  />
                </div>
              </div>
            </div>
