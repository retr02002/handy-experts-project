    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
        <div className="flex flex-col md:flex-row items-center gap-6">
          <div className="w-24 h-24 rounded-full bg-[#00B4FF] flex items-center justify-center text-white font-bold text-3xl ring-4 ring-blue-50 dark:ring-slate-700">
            CU
          </div>
          <div className="text-center md:text-left">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">Customer User</h2>
            <p className="text-slate-500 dark:text-slate-400 mb-4">customer@example.com</p>
