    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 text-center shadow-sm">
        <div className="w-16 h-16 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4">
          <ClientIcon icon="ph:receipt" className="w-8 h-8" />
        </div>
        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">No pending bills</h3>
        <p className="text-slate-500 dark:text-slate-400 max-w-sm mx-auto mb-6">All your bills are paid and up to date.</p>
      </div>
    </div>
  );
}
