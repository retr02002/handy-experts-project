...
export const MOCK_SERVICES: Service[] = [
  {
    ...
    packages: [
      ...
      {
        name: "AC Master Combo (2 ACs Wash)",
        price: 1099,
        originalPrice: 1798,
        time: "90 mins",
        category: "Combos & Add-ons",
        tag: "Super Saver",
        rating: "4.9 (2,100)",
      ...
      {
        name: "AC Gas Top-up & Recharge",
        price: 1499,
        originalPrice: 2200,
        time: "45 mins",
        category: "Repairs & Gas",
        tag: "Genuine Gas",
        rating: "4.8 (980)",
  ...
  },
  {
    ...
    packages: [
      ...
      {
        name: "Express Toilet & Sink Shine",
        price: 249,
        originalPrice: 399,
        time: "30 mins",
        category: "Add-ons",
  ...
  },
  {
    ...
    packages: [
      ...
      {
        name: "Mattress Deep Shampoo (Double)",
        price: 649,
        originalPrice: 899,
        time: "1 hr",
        category: "Combos & Add-ons",
  ...
  },
  {
    ...
    packages: [
      ...
      { 
        name: "Kitchen & Bath Drain Unblocking", 
        price: 299, 
        originalPrice: 399, 
        time: "45 mins", 
        category: "Bestsellers",
  ...
  },
  {
    ...
    packages: [
      ...
      { 
        name: "Ceiling Fan Installation & Balance", 
        price: 199, 
        originalPrice: 299, 
        time: "45 mins", 
        category: "Bestsellers",
