...
export const MOCK_BLOGS: BlogPost[] = [
  ...
  },
  {
    ...
    content: "<p>You don't need a massive budget to breathe new life into your home. One of the most effective and affordable ways to upgrade any room is a fresh coat of paint. Whether you're doing an accent wall or brightening up a dark hallway, paint offers the highest return on investment. Furthermore, updating cabinet hardware in your kitchen or bathroom can completely transform the space for just a few dollars per handle.</p><p>Another excellent hack is utilizing smart lighting. Installing dimmer switches or smart LED bulbs allows you to change the ambiance of a room instantly. For exterior curb appeal, simply pressure washing your driveway and planting some low-maintenance perennials can make your home look brand new. Small, thoughtful updates always beat expensive overhauls.</p>",
